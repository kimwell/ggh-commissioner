  ...
  <div>
    ...
    <div class="main">
      ...
      <div class="list" v-for="item in list">
        <div class="list-item">
          <span class="nums">{{item.newBindBuserNum}}</span>
          新绑定商户数
        </div>
        <div class="list-item">
          <span class="nums">{{item.buserLoginCount}}</span>
          有效登录数
        </div>
        <div class="list-item">
          <span class="nums">{{item.ironBuyNum}}</span>
          用户求购数
        </div>
        <div class="list-item">
          <span class="nums">{{item.ironBuyFinishNum}}</span>
          求购成交数
        </div>
        <div class="list-item">
          <span class="nums">{{item.ironBuyPercent}}%</span>
          求购成交率
        </div>
        <div class="list-item">
          <span class="nums">{{item.storeOrderNum}}</span>
          订单数量
        </div>
        <div class="list-item">
          <span class="nums">{{item.storeOrderFinishNum}}</span>
          订单完成数
        </div>
        <div class="list-item">
          <span class="nums">{{item.storeOrderPercent}}%</span>
          订单完成率
        </div>
        <div class="list-item">
          <span class="nums">{{item.totalBindUserNum}}</span>
          总绑定用户
        </div>
      </div>
    </div>
